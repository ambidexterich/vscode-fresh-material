Theme Color
============
[Official Guide](https://code.visualstudio.com/docs/getstarted/theme-color-reference)
...
A set of colors for button widgets such as <strong>Open Folder</strong> button in the Explorer of a new window.

![button control](https://code.visualstudio.com/assets/api/references/theme-color/button.png)
...
![dropdown control](https://code.visualstudio.com/assets/api/references/theme-color/Dropdown.png)
...
![input control](https://code.visualstudio.com/assets/api/references/theme-color/input.png)
...
![editorGroup.border](https://code.visualstudio.com/assets/api/references/theme-color/editorGroup-border.gif)

* `editorGroup.dropBackground`: Background color when dragging editors around.

![editorGroup.dropBackground](https://code.visualstudio.com/assets/api/references/theme-color/editorGroup-dropbackground.gif)
...
![editorGroupHeader.noTabsBackground](https://code.visualstudio.com/assets/api/references/theme-color/editorgroupheader-notabsbackground.gif)

* `editorGroupHeader.tabsBackground`: Background color of the Tabs container.

![editorGroupHeader.tabsBackground](https://code.visualstudio.com/assets/api/references/theme-color/editorgroupheader-tabsbackground.gif)

* `editorGroupHeader.tabsBorder`: Border color below the editor tabs control when tabs are enabled.

![editorGroupHeader.tabsBorder](https://code.visualstudio.com/assets/api/references/theme-color/editorgroupheader-tabsborder.gif)
...
![selection highlight](https://code.visualstudio.com/assets/api/references/theme-color/selectionhighlight.png)
...
![occurrences](https://code.visualstudio.com/assets/api/references/theme-color/occurrences.png)
...
![Find matches](https://code.visualstudio.com/assets/api/references/theme-color/findmatches.png)
...
![Search Editor Matches](https://code.visualstudio.com/assets/api/references/theme-color/searchEditorMatches.png)
...
![Hover Highlight](https://code.visualstudio.com/assets/api/references/theme-color/hoverhighlight.png)
...
![Line Highlight](https://code.visualstudio.com/assets/api/references/theme-color/line.png)
...
![Link](https://code.visualstudio.com/assets/api/references/theme-color/link.png)

* `editorLink.activeForeground`: Color of active links.

The range highlight is visible when selecting a search result.

![Range Highlight](https://code.visualstudio.com/assets/api/references/theme-color/rangehighlight.png)
...
The symbol highlight is visible when navigating to a symbol via a command such as <strong>Go to Definition</strong>.
...
To see the editor white spaces, enable <strong>Toggle Render Whitespace</strong>.
...
![CodeLens](https://code.visualstudio.com/assets/api/references/theme-color/codelens.png)
...
![Bracket colors](https://code.visualstudio.com/assets/api/references/theme-color/bracket-colors.png)
...
The editor marker view shows when navigating to errors and warnings in the editor (<strong>Go to Next Error or Warning</strong> command).
...
![Peek view](https://code.visualstudio.comhttps://code.visualstudio.com/assets/api/references/theme-color/peek-view.png)
...
![Merge ranges](https://code.visualstudio.com/assets/api/references/theme-color/merge-ranges.png)
...
Prominent items stand out from other Status Bar entries to indicate importance. One example is the <strong>Toggle Tab Key Moves Focus</strong> command change mode indicator.
...
![Notification Toasts](https://code.visualstudio.com/assets/api/references/theme-color/notification-toast.png)

Once opened in the Notification Center, they are displayed in a list with a header:

![Notification Center](https://code.visualstudio.com/assets/api/references/theme-color/notification-center.png)
...
Extensions colors
---------------------------
* `extensionButton.prominentForeground`: Extension view button foreground color (for example <strong>Install</strong> button).
...
![Keybinding label](https://code.visualstudio.com/assets/api/references/theme-color/keybinding-label.png)
